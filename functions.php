...
/************* SHOW MENU ORDER COLUMN BACKEND **************/
...
/************* DISPLAY DIFFERENT NUMBER OF POSTS FOR CPT *********************/
...
/************* CPT ORDERBY MENU ORDER BACKEND *********************/

function posts_for_current_author($query) {
 
  if($query->is_admin) {
 
        if ($query->get('post_type') == 'house_tour')
        {
...
/************* CPT ORDERBT MENU ORDER FRONTEND *********************/
...
/************* FILTER BY TAXONOMY ON CPT BACKEND ***************/
function pippin_add_taxonomy_filters() {
	global $typenow;
 
	// an array of all the taxonomyies you want to display. Use the taxonomy name or slug
	$taxonomies = array('house_cat');
 
	// must set this to the post type you want the filter(s) displayed on
	if( $typenow == 'house_tour' ){
...
function bones_register_sidebars() {
	...
	register_sidebar(array(
		...
		'description' => __( 'Widget area in the footer.', 'bonestheme' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
